...
public class GrammerRuleHandler : IGrammerRuleHandler
{
    ...
    public void HandleRule(int ruleId)
    {
        switch (ruleId)
        {
            ...
            case 6:
                treeNodeStack.Push(new MultiplyTreeNode(treeNodeStack.Pop(), treeNodeStack.Pop(), treeNodeStack.Pop()));
                break;
            case 4:
                treeNodeStack.Push(new AddTreeNode(treeNodeStack.Pop(), treeNodeStack.Pop(), treeNodeStack.Pop()));
                break;
            case 13:
                treeNodeStack.Push(new PrintTreeNode(treeNodeStack.Pop()));
                break;
            case 2: treeNodeStack.Push(new ProgramTreeNode(treeNodeStack.Pop())); break;
            case 1:
                ITreeNode statementTreeNode = treeNodeStack.Pop();
